...
|--------|--------|-----------|-------------|
| 1 | **Algorithms** | Sorting, searching, greedy algorithms, dynamic programming, backtracking, divide and conquer, pattern searching. | 30 |
| 2 | **Data Structures** | Array, linked list, stack, queue, binary tree, indexing, binary search tree, heap, hashing, matrix, JSON objects. | 40 |
