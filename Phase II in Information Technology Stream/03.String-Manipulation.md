...
**String manipulation** refers to performing operations on strings (a sequence of characters) such as finding length, extracting parts, searching text, and matching patterns.

Strings are commonly used to store **text**, such as names, sentences, passwords, and messages.
